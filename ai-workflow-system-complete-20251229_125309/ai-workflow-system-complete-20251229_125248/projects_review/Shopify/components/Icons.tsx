...
export const CheckCircleIcon = ({ className = "w-6 h-6", checked = false }: { className?: string; checked?: boolean }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill={checked ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
